...
## ⭐ CURRENT CANONICAL ENDPOINT — D309 / SYSTEM_MAP v1.14 / HANDOFF v113G-M1 (consistency patch 2026-07-18)
...
- **Code HEAD accepted:** `4014427d` · **Docs HEAD:** `a95d9d0c` (kế `d62cc445`).
- **Inventory sống (18/07/2026):** **87 tables · 190 SECURITY DEFINER functions · 164 policies · 1 cron · 101 migrations · routes 52 (raw fullPaths 57) · 16 Edge Functions.**
- **Parent shell:** mobile **≤479** · tablet **480–1023** · desktop **≥1024**.
- **Trạng thái:** **V113G-M1 SEALED** · **no sprint currently open.**
