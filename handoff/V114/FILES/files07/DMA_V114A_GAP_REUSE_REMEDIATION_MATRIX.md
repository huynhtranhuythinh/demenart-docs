...
| T-09 | Gửi nhật ký | `submit_session_journal` | — | ✅ `is_session_lead` | — | ✅ | **AUTHORIZATION-READY — RELEASE BEHAVIOR PENDING OD-3** | hành vi hiện tại: **cho gửi kèm cảnh báo** khi điểm danh chưa đủ — giữ hay chặn là quyết định sản phẩm | — | — | — | **OD-3** |
