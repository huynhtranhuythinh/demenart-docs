...
## 7 · Canonical sync checklist (this session)

- [x] `DMA_RULES.md` ← append **D372** block (byte-prefix through D371 immutable) — artifact `DMA_RULES__APPEND_D372.md`.
- [x] `DMA_SYSTEM_MAP.md` ← append **v1.60** block (byte-prefix through v1.59 immutable) — artifact `DMA_SYSTEM_MAP__APPEND_v1.60.md`.
- [x] `DMA_HANDOFF_V128-B11.2-A-AMENDMENT-CLOSEOUT.md` (this file).

*Append-only: paste each block VERBATIM at the end of the real on-disk file, after the stated anchor. Do not rewrite D371 / v1.59.*
