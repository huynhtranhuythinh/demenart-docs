    ...
    return (
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-dma-serif text-lg text-dma-ink">Hành trình của con</h2>
          {chevron}
        </div>
  ...
  if (state === "insufficient") {
    return (
      ...
      >
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-dma-ink-2">
          Hành trình của con vẫn đang được ghi lại mỗi ngày. Khi đủ dấu vết, Dế Mèn sẽ cùng ba mẹ
          nhìn lại.
        </p>
      </Link>
    );
